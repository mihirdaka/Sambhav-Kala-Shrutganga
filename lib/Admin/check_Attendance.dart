...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CupertinoApp(
      ...
      home: check_Attendance(title: 'Flutter Demo Home Page'),
...
class check_Attendance extends StatefulWidget {
  check_Attendance({Key key, this.title}) : super(key: key);
  ...
  @override
  _check_AttendanceState createState() => _check_AttendanceState();
}
     ...
     print(_sid);
                final snapShot = await Firestore.instance
                  ...
                  if (snapShot == null || !snapShot.exists) {
                    ...
                    print(_sid);
                        crudObj.getAttendancedata(this._sid.toUpperCase()).then((docs){
                          setState(() {
